...
* gplat.Log.logger("lean_smooth").Info("Smoothed y:" + fromY + " vec3:" + fromVec3 + " color:" + fromColor);<br />
*
* @class LeanSmooth
*/
...
public class LeanSmooth
{
    ...
    * gplat.Log.logger(lean_smooth).Info("current:"+followVar);
    */
    ...
    * gplat.Log.logger(lean_smooth).Info("current:"+transform.position);
    */
    ...
    * gplat.Log.logger(lean_smooth).Info("current:"+fromColor);
    */
