...
public class LTDescr
{
	...
	private log4net.ILog m_logger = gplat.Log.logger("lt_desc");
	...
	{
		// m_logger.Info("canceling id:"+this._id+" this.uniqueId:"+this.uniqueId+" go:"+this.trans.gameObject);
	...
	public LTDescr setRotateAround()
	{
		...
		this.easeInternal = () =>
		{
			...
			// m_logger.Info("this._optional.point:"+this._optional.point);
	...
	public LTDescr setColor()
	{
		...
		this.easeInternal = () =>
		{
			...
			{
#endif
				// m_logger.Info("val:"+val+" tween:"+tween+" tween.diff:"+tween.diff);
    ...
    */
	...
	public LTDescr setId(uint id, uint global_counter)
	{
		...
		// m_logger.Info("Global counter:"+global_counter);
		return this;
	}
    ...
    * @example
    * <i>C#:</i><br>
    * LeanTween.moveX(gameObject, 5f, 2.0f ).setOnStart( ()=>{ m_logger.Info("I started!"); });
    * <i>Javascript:</i><br>
    * LeanTween.moveX(gameObject, 5f, 2.0f ).setOnStart( function(){ m_logger.Info("I started!"); } );
    */
    ...
    */
	...
	public LTDescr setDirection(float direction)
	{
		...
		{
			// m_logger.Info("reverse path:"+this.path+" spline:"+this._optional.spline+" hasInitiliazed:"+this.hasInitiliazed);
			if (this.hasInitiliazed)
			{
