...
namespace PathCreation
{
 ...
 centre + Vector3.right * width
		...
		public BezierPath(IEnumerable<RectTransform> transforms, bool isClosed = false, PathSpace space = PathSpace.xy) :
			this(transforms.Select(t => t.anchoredPosition), isClosed, space)
		{ }
