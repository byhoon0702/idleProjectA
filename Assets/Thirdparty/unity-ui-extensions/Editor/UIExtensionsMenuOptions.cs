...
namespace UnityEditor.UI
{
	...
	static internal class ExtensionMenuOptions
	{
		...
		static public void FixedScrollSnapBase(MenuCommand menuCommand, string name, UnityEngine.UI.Extensions.ScrollSnap.ScrollDirection direction, int itemVisible, int itemCount, Vector2 itemSize)
		{
			...
			if (direction == UnityEngine.UI.Extensions.ScrollSnap.ScrollDirection.Horizontal)
			{
			...
			scrollRect.vertical = direction == UnityEngine.UI.Extensions.ScrollSnap.ScrollDirection.Vertical;
			scrollRect.horizontal = direction == UnityEngine.UI.Extensions.ScrollSnap.ScrollDirection.Horizontal;

			UnityEngine.UI.Extensions.ScrollSnap scrollSnap = scrollSnapRoot.AddComponent<UnityEngine.UI.Extensions.ScrollSnap>();
		...
		{
			FixedScrollSnapBase(menuCommand, "Scroll Snap Horizontal Single", UnityEngine.UI.Extensions.ScrollSnap.ScrollDirection.Horizontal, 1, 3, new Vector2(100, 100));
		}
		...
		{
			FixedScrollSnapBase(menuCommand, "Scroll Snap Horizontal Multiple", UnityEngine.UI.Extensions.ScrollSnap.ScrollDirection.Horizontal, 3, 15, new Vector2(100, 100));
		}
		...
		{
			FixedScrollSnapBase(menuCommand, "Scroll Snap Vertical Multiple", UnityEngine.UI.Extensions.ScrollSnap.ScrollDirection.Vertical, 1, 3, new Vector2(100, 100));
		}
		...
		{
			FixedScrollSnapBase(menuCommand, "Scroll Snap Vertical Multiple", UnityEngine.UI.Extensions.ScrollSnap.ScrollDirection.Vertical, 3, 15, new Vector2(100, 100));
		}
		#endregion
