...
Shader "SKYEffect/UI/SpriteMultiPly"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				float4 tex2DNode2 = tex2D( _MainTex, IN.ase_texcoord3.xy );
				float temp_output_11_0 = ( tex2DNode2.a * IN.ase_color.a );
				float4 lerpResult10 = lerp( float4( 1,1,1,1 ) , ( tex2DNode2 * IN.ase_color ) , temp_output_11_0);
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = lerpResult10.rgb;
				float Alpha = temp_output_11_0;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 tex2DNode2 = tex2D( _MainTex, IN.ase_texcoord2.xy );
				float temp_output_11_0 = ( tex2DNode2.a * IN.ase_color.a );
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float4 tex2DNode2 = tex2D( _MainTex, IN.ase_texcoord.xy );
				float temp_output_11_0 = ( tex2DNode2.a * IN.ase_color.a );
        ...
        Pass
        {
			...
			{
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float4 tex2DNode2 = tex2D( _MainTex, IN.ase_texcoord1.xy );
				float temp_output_11_0 = ( tex2DNode2.a * IN.ase_color.a );
...
/*ASEBEGIN
Version=18935
2230;23;1449;929;632.7819;395.7709;1;True;True
...
Node;AmplifyShaderEditor.SamplerNode;2;-467,-48.5;Inherit;True;Property;_MainTex;MainTex;0;0;Create;True;0;0;0;False;0;False;-1;None;24bfeff71d6ab6c40bd30aeed05b3477;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=4EE29C93765925FD43FFE408345BB8D7F60F462B