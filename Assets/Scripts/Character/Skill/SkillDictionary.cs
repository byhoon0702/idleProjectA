...
public static class SkillDictionary
{
	public static Dictionary<string, object[]> dic = new Dictionary<string, object[]>() 
	{
		...
		{ typeof(Landrock_sk1).ToString(), new object[] { new Landrock_sk1Data(new KnockbackConditionData(0.5f, 1), new DamageDownConditionData(0.05f, 4), 3, 1.12f, 5) } },
		...
		{ typeof(Gilius_sk1).ToString(), new object[] { new Gilius_sk1Data(new AttackPowerUpConditionData(0.084f, 6), new CriticalChanceUpConditionData(0.035f, 6), 5.46f, 10) } }
	};
}
