...
public class NormalUnitCostume : UnitCostume
{
	...
	{
		//var headinfo = PlatformManager.UserDB.costumeContainer[CostumeType.HEAD];
		//var bodyinfo = PlatformManager.UserDB.costumeContainer[CostumeType.BODY];
		//var weaponinfo = PlatformManager.UserDB.costumeContainer[CostumeType.WEAPON];
