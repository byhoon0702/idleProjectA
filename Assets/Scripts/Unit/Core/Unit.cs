...
public abstract class Unit : HittableUnit
{
	...
	public virtual void Init()
	{
		...
		if (buffModule == null)
		{
			buffModule = gameObject.AddComponent<BuffModule>();
		}
	...
	public virtual void InitMode(GameObject go)
	{
	...
	{
		if (GameSetting.Instance.Fx == false)
		{
			return;
		}

		SoundManager.Instance.PlayEffect(hitAudioClip);

	}

	protected virtual void OnFxChange(bool isOn)
	{
