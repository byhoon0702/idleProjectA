...
[RequireComponent(typeof(SortingGroup), typeof(BoxCollider2D))]
public class UnitAnimation : MonoBehaviour
{
	...
	public void Init()
	{
		...
		gameObject.ChangeLayer(transform.parent.gameObject.layer);
	}
	...
	public void UpdateRenderer()
	{
		...
		renderers = transform.GetComponentsInChildren<SpriteRenderer>(true);
	}
	...
	public void SetMaskInteraction(SpriteMaskInteraction maskInteraction = SpriteMaskInteraction.None)
	{
		for (int i = 0; i < renderers.Length; i++)
		{
			renderers[i].maskInteraction = maskInteraction;
		}
	}
