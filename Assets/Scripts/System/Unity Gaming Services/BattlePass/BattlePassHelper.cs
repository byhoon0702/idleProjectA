...
namespace BattlePass
{
	public static class BattlePassHelper
	{
		public static int MaxEffectiveSeasonXp(BattlePassConfig battlePassConfig)
		{
			...
			return battlePassConfig.seasonXpPerTier * (battlePassConfig.battlePassTierCount - 1);
		}

		public static int GetCurrentTierIndex(int seasonXP, BattlePassConfig battlePassConfig)
		{
			return Math.Min(seasonXP / battlePassConfig.seasonXpPerTier, battlePassConfig.battlePassTierCount - 1);
		}

		public static int GetNextTierIndex(int seasonXP, BattlePassConfig battlePassConfig)
		{
			return Math.Min(GetCurrentTierIndex(seasonXP, battlePassConfig) + 1, battlePassConfig.battlePassTierCount - 1);
		}
