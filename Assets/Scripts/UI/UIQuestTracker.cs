...
public class UIQuestTracker : MonoBehaviour
{
	...
	public void OnUpdate()
	{
		...
		{
			temp = GameManager.UserDB.questContainer.CurrentMainQuest;
		}
		else
		{
			temp = GameManager.UserDB.questContainer.GetNonMainQuest();
		}
		...
		uiTextQuestType.SetKey(questInfo.Type.ToString());
