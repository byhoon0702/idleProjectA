...
public class UIPropertyData
{
	...
	private UserPropertyData propertyData;
	...
	public VResult Setup(ItemData _itemData, UserPropertyData _propertyData)
	{
		itemData = _itemData;
	...
	public bool Levelupable()
	{
		...
		if (UserInfo.RemainPropertyPoint < LevelupConsumeCount)
		{
			return false;
		}
