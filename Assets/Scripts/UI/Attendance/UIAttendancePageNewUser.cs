...
public class UIAttendancePageNewUser : UIAttendancePage
{
	...
	public void Init()
	{
		var list = PlatformManager.UserDB.attendanceContainer.AttendanceList.Find(x => x.RawData.limitType == TimeLimitType.USER);
